...
6. You want to contribute a new development to your partner's repository. To do so, first clone **your fork** of their repository to your local computer:
   * If you are not already there, go to your fork's website on GitHub. The web address should be something like `https://github.com/YOUR_USERNAME/THEIR_USERNAME-test-repo`.
